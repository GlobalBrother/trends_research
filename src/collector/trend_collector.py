...
class TrendCollector:
    ...
    def run_hackernews_scraper(self):
        """Runs the Scrapy HackerNews spider."""
        return self._run_scraper("hackernews")

    def run_reddit_scraper(self, subreddit='all', trend_type='hot'):
        """Runs the Scrapy Reddit spider."""
        return self._run_scraper("reddit", subreddit=subreddit, trend_type=trend_type)
    ...
    def run_stackexchange_scraper(self, site='stackoverflow', sort='hot'):
        """Runs the Scrapy StackExchange spider."""
        return self._run_scraper("stackexchange", site=site, sort=sort)
    ...
    def collect_all(self, geo=None, include_trending_now=False, include_youtube=False, include_social=False, include_hackernews=False, include_reddit=False, include_news=False, include_stackexchange=False):
        all_trends = []
        all_trends.extend(self.get_scrapy_trends(geo=geo, include_trending_now=include_trending_now, include_youtube=include_youtube, include_social=include_social, include_hackernews=include_hackernews, include_reddit=include_reddit, include_news=include_news, include_stackexchange=include_stackexchange))
